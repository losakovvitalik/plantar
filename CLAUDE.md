...
Комментарии — на английском. Это касается и новых файлов, и новых строк в существующих.
Старые русские комментарии не переписывать без отдельного запроса (см. п. 3 «Surgical Changes»).
