...
export const ru = {
  ...
  "deploy.deployedNoResponse":
    "Приложение обновлено, но по адресу {url} оно не ответило. Проверьте, что этот адрес настроен на сервере.",
  ...
  "deploy.rolledBackNoResponse":
    "Предыдущая версия возвращена, но по адресу {url} приложение не ответило. Проверьте, что этот адрес настроен на сервере.",
