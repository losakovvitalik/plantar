...
export const ru = {
  ...
  "trustHostKey.description":
    "Plantar снова начнёт подключаться к этому серверу и будет считать его прежним. Сервер и его проекты останутся в списке, настраивать их заново не придётся.",
