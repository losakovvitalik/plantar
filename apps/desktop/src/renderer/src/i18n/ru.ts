...
export const ru = {
  ...
  "deploy.deployedNoResponse":
    "Приложение обновлено, но по адресу {url} оно не ответило. Возможно, этот адрес ещё не настроен на сервере или изменения дойдут через несколько минут.",
  ...
  "deploy.rolledBackNoResponse":
    "Предыдущая версия возвращена, но по адресу {url} приложение не ответило. Возможно, этот адрес ещё не настроен на сервере или изменения дойдут через несколько минут.",
