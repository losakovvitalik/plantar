...
export const ru = {
  ...
  "trustHostKey.description":
    "Plantar снова начнёт подключаться к этому серверу и будет считать его прежним. Сервер и его проекты останутся в списке. Если для проектов этого сервера настроен деплой при коммите, настройте его заново: в GitHub записан прежний ключ, и деплой оттуда не пройдёт.",
  ...
  "trustHostKey.fingerprintHint":
    "Хостинг обычно показывает ключи сервера в панели управления — по одной строке на каждый вид. Сравнивать нужно строку того же вида, что указан выше: у строк другого вида значения не совпадут, и это нормально. Если значения совпадают — это ваш сервер. Если строки нужного вида в панели нет, уточните у хостинга, действительно ли сервер переустанавливали.",
