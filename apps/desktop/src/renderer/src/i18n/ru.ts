...
export const ru = {
  ...
  "settings.mcpServerHint":
    "ИИ-агенты на этом компьютере (например, Claude Code или Cursor) смогут читать сведения о ваших серверах и приложениях: состояние, логи, посещаемость, историю деплоев. Изменять что-либо они не смогут.",
  ...
  "settings.mcpAfterSave":
    "Адрес и ключ доступа появятся здесь после сохранения настроек.",
