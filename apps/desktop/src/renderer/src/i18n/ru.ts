...
export const ru = {
  ...
  "trustHostKey.fingerprintHint":
    "Обычно такую же строку хостинг показывает в панели управления сервером. Если значения совпадают — это ваш сервер. Если такой строки там нет, уточните у хостинга, действительно ли сервер переустанавливали.",
