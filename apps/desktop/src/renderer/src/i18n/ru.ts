...
export const ru = {
  ...
  "projectSettings.domainExternalHint":
    "Адрес нужен только для того, чтобы после обновления проверить, отвечает ли приложение. У импортированного приложения Plantar не настраивает ни адрес, ни HTTPS-сертификат: они остаются такими, как настроены на сервере. Если приложение открывается по другому адресу или его нет совсем, поле можно исправить или оставить пустым.",
