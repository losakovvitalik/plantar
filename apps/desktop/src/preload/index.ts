...
const api: PlantarApi = {
  ...
  backfillDeployOnCommit: (serverId) => invoke("github:backfillDeployOnCommit", serverId),
  ...
  onServerIdentitySettled: (callback) => subscribe("server:identity-settled", callback),
